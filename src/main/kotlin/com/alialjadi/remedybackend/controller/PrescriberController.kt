...
class PrescriberController(
    ...
    //    set bag state
    @Operation(summary = "Set bag state", description = "Sets the state of a bag (e.g., SEALED, UNSEALED)" +
    ...
    @Operation(summary = "Get patient prescription history", description = "Returns all previous prescriptions for a patient")
